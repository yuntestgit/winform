...
#End Region
    ...
    Dim receivestart As Boolean = False
    Private Sub Timer1_Tick(sender As System.Object, e As System.EventArgs) Handles Timer1.Tick
        If h Then
            Try
                bmp = PrintWindow(h)

                If receivestart Then
                    If sb(total + 8) Then
                        receivestart = False
                        Timer1.Stop()
                        Timer3.Start()
                        Exit Sub
                    ElseIf sb(total + 9) Then
                        receivestart = False
                        Timer1.Stop()
                        Timer3.Start()
                        Exit Sub
    ...
    Private Sub Timer2_Tick(sender As System.Object, e As System.EventArgs) Handles Timer2.Tick
        ...
        If childHWND Then
            'Me.Text = Hex(childHWND).ToString
            Dim sameClass As Integer = FindWindow("QWidget", "player")
            If sameClass <> childHWND Then
    ...
    Dim receiveall As Boolean = False
        ...
        If h Then
            Try
                ...
                If receiveall Then
                    ...
                    End If
                Else
                    If Not sb(total + 1) Then
                        For i = total + 4 To total + 9
                            If sb(i) Then
                                sendclick(i)
                                Exit For
                            End If
    ...
    Private Sub Timer4_Tick(sender As System.Object, e As System.EventArgs) Handles Timer4.Tick
        Dim cp As Point = New Point(650, 450)
        PostMessage(h, WM_LBUTTON_DOWN, 0, MAKELPARAM(cp.X, cp.Y))
        PostMessage(h, WM_LBUTTON_UP, 0, MAKELPARAM(cp.X, cp.Y))
    End Sub
