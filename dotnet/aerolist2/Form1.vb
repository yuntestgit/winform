Public Class Form1
    ...
    Private Sub ListBox1_DrawItem(sender As System.Object, e As System.Windows.Forms.DrawItemEventArgs) Handles ListBox1.DrawItem
        'Dim selected As Integer = DrawItemState.Selected or 
        Dim isSelected1 As Integer = DrawItemState.NoFocusRect + DrawItemState.NoAccelerator + DrawItemState.Selected + DrawItemState.Focus
        Dim isSelected2 As Integer = DrawItemState.Selected
        Dim isSelected3 As Integer = DrawItemState.NoFocusRect + DrawItemState.NoAccelerator + DrawItemState.Selected
        Dim isSelected4 As Integer = DrawItemState.Selected + DrawItemState.Focus + DrawItemState.NoAccelerator
        If e.State = isSelected1 Or e.State = isSelected2 Or e.State = isSelected3 Or e.State = isSelected4 Then
        ...
        ElseIf e.State = DrawItemState.NoFocusRect + DrawItemState.NoAccelerator Then
            e.Graphics.FillRectangle(New SolidBrush(Color.Blue), e.Bounds)
            e.Graphics.DrawString(ListBox1.Items.Item(e.Index), e.Font, Brushes.Red, e.Bounds)
        ElseIf e.State = DrawItemState.NoFocusRect + DrawItemState.NoAccelerator + DrawItemState.Selected + DrawItemState.Focus Then
            e.Graphics.FillRectangle(New SolidBrush(Color.Yellow), e.Bounds)
            e.Graphics.DrawString(ListBox1.Items.Item(e.Index), e.Font, Brushes.Red, e.Bounds)
        Else
            'ListBox2.Items.Clear()
            'ListBox2.Items.Add(e.State)
        ...
        Namespace EventHandler
            ...
            Public Class AeroListbox
                ...
                Private Sub _DrawItem(sender As System.Object, e As System.Windows.Forms.DrawItemEventArgs)
                    Dim isSelected As Integer = DrawItemState.NoFocusRect + DrawItemState.NoAccelerator + DrawItemState.Selected + DrawItemState.Focus
                    If e.State = DrawItemState.Selected Or e.State = isSelected Then
