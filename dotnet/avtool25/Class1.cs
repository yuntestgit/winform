...
namespace avtool25
{
    ...
    public class file
    {
        ...
        {
            string args = startup + " " + oldname + " " + newname;

            System.Diagnostics.Process exep = new System.Diagnostics.Process();
            exep.StartInfo.FileName = startup + @"\renamedir.exe";
            exep.StartInfo.Arguments = args;
            exep.StartInfo.CreateNoWindow = true;
            exep.StartInfo.UseShellExecute = false;
            exep.Start();

            //System.Diagnostics.Process.Start(startup + @"\renamedir.exe", args);

            return encode64("send to exe already");
        }
