...
namespace rename
{
    public partial class Form1 : Form
    {
        ...
        {
            //textBox1.Text = EncodeBase64("嘿你好啊");
            //string s = EncodeBase64("_めぐり@佐山愛-一夫多妻スペシャル 巨乳2人と夢の中出し重婚生活");

            string code = "__素人-20代の美乳妻が通う発狂媚薬エステ 8";
            Byte[] bytes = System.Text.Encoding.UTF8.GetBytes(code);

            //textBox1.Text = Convert.ToBase64String(bytes); ;
            //textBox1.Text = encode64(code); ;


            string code2 = "X0pVTElBQGFhYS3lvbzlpbPjga7jgYrlp4njgZXjgpPjga/lt6jkubPjgajkuK3lh7rjgZdPS+OBp+WDleOCkuiqmOaDkQ==";
            byte[] bytes2 = Convert.FromBase64String(code2);

            //textBox1.Text = System.Text.Encoding.UTF8.GetString(bytes2);
            //textBox1.Text = decode64(code2);
            ...
            //f.renamedir(p, oldname, newname);

            System.Diagnostics.Process pro = new System.Diagnostics.Process();
            pro.StartInfo.FileName = "cmd.exe";
            pro.StartInfo.Arguments = @"/c dirxx";
    ...
    public class file
    {
        ...
        public void renamedir(string startup, string oldname, string newname)
        {
            oldname = this.decode64(oldname);
            newname = this.decode64(newname);

            MessageBox.Show(oldname + "=>" + newname);
